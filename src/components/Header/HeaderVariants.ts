...
export const variantAccount = {
	...
	animate: { y: 0, opacity: 1, scale: 1, transition: { ease: 'linear', duration: 0.25 } },
};

export const variantCart = {
	initial: { y: -70, opacity: 0, scale: 0 },
	animate: { y: 0, opacity: 1, scale: 1, transition: { ease: 'linear', delay: 0.2, duration: 0.25 } },
};

export const variantOut = {
	initial: { y: -90, opacity: 0, scale: 0 },
	animate: { y: 0, opacity: 1, scale: 1, transition: { ease: 'linear', delay: 0.4, duration: 0.25 } },
};
